...
public class ExtentReportListner {
	...
	ExtentReports extent;
	 ...
	 extent = new ExtentReports (System.getProperty("user.dir") +"/test-output/STMExtentReportw.html", true);
	 ...
	 String screenshotPath = ExtentReportListner.getScreenshot(driver, result.getName());
